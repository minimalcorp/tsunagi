  ...
  return (
    <div className="flex items-center gap-2 border-b border-theme pb-2 mb-4 overflow-x-auto">
      {sessions.map((session) => {
        ...
        return (
          <div
            key={session.id}
            className={`
              flex items-center gap-2 px-4 py-2 h-8 rounded-t-lg cursor-pointer flex-shrink-0
              ${
                isActive
      ...
      <button
        ...
        className="px-4 py-2 h-8 bg-primary text-white rounded-t-lg hover:bg-primary-hover flex-shrink-0 flex items-center justify-center cursor-pointer"
