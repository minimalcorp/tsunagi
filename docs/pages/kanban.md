...
Kanban UIは、タスクを視覚的に管理するためのメインインターフェースです。6列のカラム（Backlog、Planning、Tasking、Coding、Reviewing、Done）でタスクのステータスを表現し、ドラッグ&ドロップで直感的に操作できます。
...
│  │        │ │        │ │        │ │        │ │        │ │        │                 │
│  │┌──────┐│ │┌──────┐│ │┌──────┐│ │┌──────┐│ │┌──────┐│ │┌──────┐│                 │
│  ││Task1 ││ ││Task3 ││ ││Task5 ││ ││Task7 ││ ││Task9 ││ ││TaskA ││                 │
│  │└──────┘│ │└──────┘│ │└──────┘│ │└──────┘│ │└──────┘│ │└──────┘│                 │
│  │        │ │        │ │        │ │        │ │        │ │        │                 │
│  │┌──────┐│ │┌──────┐│ │┌──────┐│ │┌──────┐│ │        │ │        │                 │
...
Tsunagiでは、タスクの進行状態を6つのカラムで管理します：

| カラム        | status値    | 説明                   | 成果物                                   |
| ------------- | ----------- | ---------------------- | ---------------------------------------- |
| **Backlog**   | `backlog`   | タスク作成済み、未着手 | タスク定義                               |
| **Planning**  | `planning`  | 要件定義・仕様作成中   | docs以下のドキュメント（仕様書、設計書） |
| **Tasking**   | `tasking`   | 実装計画作成中         | ステップバイステップの実装手順書         |
| **Coding**    | `coding`    | 実装中                 | ソースコード                             |
| **Reviewing** | `reviewing` | 動作確認中             | テスト結果、レビューコメント             |
| **Done**      | `done`      | 完了                   | -                                        |
  ...
  return (
    <DragDropContext onDragEnd={handleDragEnd}>
      <div className="flex-1 flex gap-4 p-6 overflow-x-auto">
        ...
        <KanbanColumn title="Tasking" status="tasking" tasks={taskingTasks} />
